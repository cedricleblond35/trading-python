...
async def main():
    ...
    try:
        ...
        await moyMobil_05_120.EMA(26, 5)
        #
        # # Awesome ##################################################################################################
            ...
            if 0 <= j < 5 and 2 < todayPlus2Hours.hour < 22:
                ...
                if c.getTick() is not None:
                    ...
                    if len(tradeOpen['returnData']) == 0:
                        ...
                        if bougie1M05.get("EMA70") is not None and superM05t1 is not None:
                            print("************ Analyse strategie 1 ***********************************************")
                            if bougie0M05["close"] > superM05t1 and bougie1M05.get("EMA70") > PPF > superM05t1 and bougie0M05["close"] > PPF:
                            ...
                            elif bougie0M05["close"] < superM05t1 and bougie1M05.get("EMA70") < PPF < superM05t1 and bougie0M05["close"] < PPF:
                        ...
                        for trade in tradeOpenDic['returnData']:
                            ...
                            if TransactionSide.BUY_LIMIT == trade['cmd']:
                                if trade["customComment"] == "str1":
                                    if superM05t1 > PPF:
                                        print("deleted BUY_LIMIT")
                                        print("trade :", trade)
                                        o.delete(trade)
