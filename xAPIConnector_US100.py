...
async def main():
    ...
    try:
        ...
        while True:
            ...
            spM013008 = Supertrend(SYMBOL, "M01", 30, 6)
            superM01_3008T0, superM01_3008T1, superM01_3008T2 = spM013008.getST()
            ...
            if c.getTick() is not None:
                ...
                print("superM01_3008T1 :", superM01_3008T1)
                print("--------------------------------------------------")
                ...
                if len(tradeOpen['returnData']) == 0:
                    ...
                    for trade in tradeOpenDic['returnData']:
                        ...
                        if TransactionSide.BUY_LIMIT == trade['cmd']:
                            ...
                            sl = round(float(superM01_3008T1), 2)
                        ...
                        #############" ordre execute ##################"
                            ...
                            if trade['customComment'] == "Vente direct":
                                print("vente direct ok : sl :", superM01_3008T1)
                                sl = superM01_3008T1
                                o.moveStopSell(trade, sl, tick)
                            else:
                                sl = round(bougie1M01["EMA120"] + ecart/4, 2)
