        ...
        while True:
            ...
            if tick is not None:
                if len(tradeOpen['returnData']) == 0:
                    ...
                    if bougieM05_1['close'] > bougieM05_1['SMA120'] and superT1 > bougieM05_1['close']:
                        support = supportDown
...
if __name__ == "__main__":
    #https://www.sqlpac.com/fr/documents/python-parsing-des-arguments-avec-les-packages-argparse-et-getopt.html
    # parser = argparse.ArgumentParser()
    # parser.add_argument("-s", nargs='*', help="simulation")
    # parser.add_argument("-d", help="demo")
    # parser.add_argument("-r", help="real")
